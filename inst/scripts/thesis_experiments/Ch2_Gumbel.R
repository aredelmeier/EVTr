...
# Note that when generating Frechet rvs and then fitting GEV, the xi will not
# be significantly different then 0
# So then a gumbel df should be fit
# Then xi is set to NA
...
round(frechet_table, 5) # - Table 2-1, GEV RVs Generated 1st part
...
round(pareto_table, 3) # - Table 2-1, GP RVs Generated 1st part
