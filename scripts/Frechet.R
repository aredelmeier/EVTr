...
#P(X > xm)
Prob_frechet_hat <- 1 - exp(-(1 + xi_frechet_hat*((xk - mu_frechet_hat)/sigma_frechet_hat))^(-1/xi_frechet_hat))
...
#P(X > xm)
Prob_frechet_hat2 <- 1 - exp(-(1 + xi_frechet_hat2*((xk - mu_frechet_hat2)/sigma_frechet_hat2))^(-1/xi_frechet_hat2))

# the k-level return level is
zk_frechet_hat2 = mu_frechet_hat2 - (sigma_frechet_hat2/xi_frechet_hat2)*(1 - (-log(1 - 1/k))^(-xi_frechet_hat2))
