...
<!-- badges: start -->
[![R build status](https://github.com/aredelmeier/EVTr/workflows/R/badge.svg)](https://github.com/aredelmeier/EVTr/actions?query=workflow%3AR-CMD-check)
...
This package accompanies a [masters thesis](https://escholarship.mcgill.ca/concern/theses/fn107132j) called "Using extreme value theory to model severe injuries of circus artists". 
...
To install the package and _also_ download the vignette use:
...
Once the package is loaded, find help on the most important functions in the package using:
...
To find specific help on one of the functions use (with correct name of function):
...
Then you can easily calculate the non-censored genearlized Pareto distribution MLE with:
